package com.flexdevit.relay42.iot.server.config.security;

import com.flexdevit.relay42.iot.server.filter.JwtAuthenticationFilter;
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                                .requestMatchers("/", "/swagger-ui/**", "/api-docs", "/api-docs/**").permitAll() // white list (swagger and root entry point)
                                 .requestMatchers(HttpMethod.POST, "/login").permitAll() // white list: login endpoint
